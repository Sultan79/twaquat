            ...
            children: [
              Container(
                ...
                child: Wrap(
                  ...
                  children: [
                    Text('how to play'.tr()),
                    Text("Simply look at each game and attempt to predict the final scoreline. To enter your scores, click on the up and down arrows next to each team.".tr() +
                        " " +
              ...
              Container(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    Text('If you predict the correct score you will be awarded 3 points. (e.g. your prediction England 3-2 Germany, actual score England 3-2 Germany, therefore 3 points).'.tr() +
                        " " +
              ...
              Container(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    Text('All players will be deemed to have accepted the rules of the game. To avoid disappointment players should ensure their predictions are entered and updated comfortably before the 15 minute deadline to account for any internet access issue that is outside of the administrators control.'.tr() +
                        " " +
              ...
              Container(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    Text('When a penalty shootout occurs, the penalties scored will count for the result, but not for the final score. Therefore, if a prediction was made that Team A will win the match, then 1 point will be awarded if Team A wins on penalties.'.tr() +
                        " " +
